...
[&darr; API - Trapit](https://github.com/BrenPatF/trapit_oracle_tester#api---trapit)<br/>
[&darr; API - Trapit_Run](https://github.com/BrenPatF/trapit_oracle_tester#api---trapit_run)<br/>
[&darr; Installation](https://github.com/BrenPatF/trapit_oracle_tester#installation)<br/>
[&darr; Operating System/Oracle Versions](https://github.com/BrenPatF/trapit_oracle_tester#operating-systemoracle-versions)

## Background
[&uarr; In this README...](https://github.com/BrenPatF/trapit_oracle_tester#in-this-readme)

I explained the concepts involved in a presentation at the Oracle User Group Ireland Conference in March 2018:
...
## Usage
[&uarr; In this README...](https://github.com/BrenPatF/trapit_oracle_tester#in-this-readme)<br/>
[&darr; Usage - General](https://github.com/BrenPatF/trapit_oracle_tester#usage---general)<br/>
[&darr; Usage - Example](https://github.com/BrenPatF/trapit_oracle_tester#usage---example)
...
### Usage - Example
[&uarr; Usage](https://github.com/BrenPatF/trapit_oracle_tester#usage)<br/>
[&darr; Input JSON File](https://github.com/BrenPatF/trapit_oracle_tester#input-json-file)<br/>
[&darr; Unit Test PL/SQL Wrapper Function](https://github.com/BrenPatF/trapit_oracle_tester#unit-test-plsql-wrapper-function)<br/>
[&darr; Unit Test Formatted Results](https://github.com/BrenPatF/trapit_oracle_tester#unit-test-formatted-results)

The example comes from [Oracle PL/SQL network analysis module](https://github.com/BrenPatF/plsql_network)

#### Input JSON File
[&uarr; Usage - Example](https://github.com/BrenPatF/trapit_oracle_tester#usage---example)<br/>
[&darr; purely_wrap_all_nets_inp.csv](https://github.com/BrenPatF/trapit_oracle_tester#purely_wrap_all_nets_inp.csv)<br/>
[&darr; purely_wrap_all_nets_out.csv](https://github.com/BrenPatF/trapit_oracle_tester#purely_wrap_all_nets_out.csv)<br/>
[&darr; purely_wrap_all_nets_temp.json](https://github.com/BrenPatF/trapit_oracle_tester#purely_wrap_all_nets_temp.json)<br/>
[&darr; tt_net_pipe.purely_wrap_all_nets_inp.json](https://github.com/BrenPatF/trapit_oracle_tester#tt_net_pipe.purely_wrap_all_nets_inp.json)<br/>
...
[&uarr; Input JSON File](https://github.com/BrenPatF/trapit_oracle_tester#input-json-file)
```
group,field
Link,Link Id
Link,Node Id From
...
## Installation
[&uarr; In this README...](https://github.com/BrenPatF/trapit_oracle_tester#in-this-readme)<br/>
[&darr; Install 1: Install pre-requisite module](https://github.com/BrenPatF/trapit_oracle_tester#install-1-install-pre-requisite-module)<br/>
[&darr; Install 2: Install Oracle Trapit module](https://github.com/BrenPatF/trapit_oracle_tester#install-2-install-oracle-trapit-module)<br/>
[&darr; Install 3: Create synonyms to lib](https://github.com/BrenPatF/trapit_oracle_tester#install-3-create-synonyms-to-lib)<br/>
[&darr; Install 4: Install npm trapit package](https://github.com/BrenPatF/trapit_oracle_tester#install-4-install-npm-trapit-package)
